...
<section class="users">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Mail: <span><?php echo $fetch_users['email']; ?></span> </p>
         ...
         <a href="admin_users.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">Borrar usuario</a>
      </div>
      <?php
         };
      ?>
